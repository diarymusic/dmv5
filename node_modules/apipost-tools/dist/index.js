...
var isXml = function (val) {
    var _a;
    try {
        var element = (_a = new DOMParser_1().parseFromString(val, 'text/xml')) === null || _a === void 0 ? void 0 : _a.documentElement;
        return lodash.exports.isObject(element);
    }
    catch (ex) {
        return false;
    }
...
var jsonOption = function (a, b) {
    try {
        if (lodash.exports.isNumber(b) && !Number.isSafeInteger(b)) {
            return BigInt(b);
        }
    }
    catch (e) {
