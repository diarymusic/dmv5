        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-2">
                <div class="col-xs-8 col-sm-10 col-md-6 col-lg-6">
                    <div class="hero">
                        <h1 class="" data-text=""><?if($_SESSION['ls']==1){?>您已登录<?}else{?>您尚未登录<?}?></h1>
                        <p>如果您没有账号,您可<a href="/?action=register">在此注册</a>或<a href="/?action=login">登录</a>.</p>
                        <?if($_SESSION['ad']==1){?><p class="text-muted">您拥有管理权限。</p><?}?>
                    </div>
                </div>
            </div>
        </div>
